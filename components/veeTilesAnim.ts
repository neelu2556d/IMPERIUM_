// @ts-nocheck
/* eslint-disable */
/* ── I dashboard tile animations ──
   Ported 1:1 from public/I-dashboard.html (the approved mockup). Two effects:
   (1) the I centre — wire lights → ring colour pulse, V idle flicker, periodic
...
export function initVeeTiles(
  ...
  // requires the .vnum node: the number was removed from the home-grid I tile
  ...
  /* ── I tile ── */
  // The I-centre animation (wire feeds, ring pulse, score reveal) is decorative
  ...
  try { (function(){
    ...
    function ringPulse(color){
      // The I tile ships in variants: the score number (.vnum) was removed from
