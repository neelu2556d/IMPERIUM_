...
/* I's read on your life — the feed-first I surface (Imperium Noticed).
 * Ported 1:1 from public/I-showcase.html. Iris/purple + mint + amber palette,
      ...
      <div className={styles.wrap}>
        ...
        <div className={styles.bar}>
          <span className={styles.brand}>
            ...
            <span className={styles.nm}>Imperium <span>&middot; I</span></span>
          </span>
        ...
        <section className={styles.hero}>
          ...
          <div className={styles.heroIn}>
            ...
            <h1 className={styles.promise}>
              <span className={styles.ln}>I has watched you for <span className={styles.mintword}>eight months</span>.</span>
              <span className={styles.ln}>Here is what she <span className={styles.glow}>figured out</span>.</span>
            </h1>
            <p className={styles.sub}>Every lift, weigh-in, meal, quiet night and unplanned spend goes in. On its own, noise. Held all at once, patterns start to glow. These are the links I found in <b>your</b> life, graded by how rare and how deep they are.</p>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.rarityWrap}>
            ...
            <p className={styles.rarityNote}>This is the hunt. The <b>mythic</b> insight, the once-in-a-lifetime one, only surfaced after I had held your whole record for months. Scroll down and it is the last card, the deepest thing she knows about you.</p>
          </div>
        </section>

        {/* ============ 02 · the feed ============ */}
        <section className={styles.section}>
          <div className={styles.secHead}><span className={styles.num}>&middot;02</span><span className={styles.lbl}>What I found</span><span className={styles.rule} /></div>
        ...
        <section className={styles.section}>
          ...
          <p className={styles.secBlurb}>Every card sits on real signals. Here is one of them: the climb I has been tracking toward your bench goal. The insights are only as good as what you feed it, so it keeps getting sharper.</p>
          ...
          <div className={styles.ladder}>
            <div className={styles.lh}>how deep I goes &middot; you are near the top</div>
