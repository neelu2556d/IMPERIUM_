 ...
 * lists it, strongestBinding words come from it, and docs/I-LIBRARY.md is
 ...
 *
 * Encodes the 34 native metrics of the I Library:
 ...
 * "let I decide" after these. Sourced here (the registry) so the option
