...
const FEATURES: Record<GuideModule, { label: string; href: string; preview: GuidePreview; fresh: Copy; active: Copy }> = {
  ...
  // can. One line a day is real data I reads, so NO goal is ever leverless -
  // and it never over-promises (a note is a pulse, not a graph).
  notes: {
    label: 'Write a note in I', href: '/app/mentor', preview: 'wave',
...
export const MODULE_FEED_ME: Record<GuideModule, string> = {
  ...
  notes: 'write a note in I each day and I will start measuring your good days.',
}
 ...
 * OWN tile streams and "let I decide" after these.
 */
