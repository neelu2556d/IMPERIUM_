...
export const TILE_SPEC = `Imperium TILE SPEC v2
=====================
...
PICKING kind (the 7 shapes; this is how I reads the tile)
...
lands in their Library (with the I mark when it reports a stream); a fix
