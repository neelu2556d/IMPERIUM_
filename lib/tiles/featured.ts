...
export interface BuildRecipe {
   ...
   *  user's I stream re-keys when the html is regenerated. (infer() singularizes,
...
export const DEFS: Def[] = [
  {
    ...
    preview: {
      ...
      tags: ['7-day chart', 'streak', 'feeds I'],
      showcase: {
        variant: 'ring',
        value: 6,
        goal: 8,
  ...
  },
  {
    ...
    preview: {
      ...
      tags: ['1 to 5', 'daily check', 'feeds I'],
  ...
  },
  {
    ...
    preview: {
      ...
      tags: ['8h target', '7-day chart', 'feeds I'],
      showcase: {
        variant: 'ring',
        value: 7.5,
        goal: 8,
  ...
  },
  {
    ...
    preview: {
      ...
      tags: ['10k goal', '7-day chart', 'feeds I'],
      showcase: {
        variant: 'ring',
        value: 8400,
        goal: 10000,
  ...
  },
  {
    ...
    preview: {
      ...
      tags: ['180 g target', '7-day chart', 'feeds I'],
      showcase: {
        variant: 'ring',
        value: 152,
        goal: 180,
  ...
  },
  {
    ...
    preview: {
      ...
      tags: ['30 min goal', 'streak', 'feeds I'],
      showcase: {
        variant: 'ring',
        value: 22,
        goal: 30,
  ...
  },
  {
    ...
    preview: {
      ...
      tags: ['50 a day', '7-day chart', 'feeds I'],
      showcase: {
        variant: 'ring',
        value: 40,
        goal: 50,
