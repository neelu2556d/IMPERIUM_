 ...
 * truly build it, I hands off to the Imperium MCP in Claude Code).
 *
...
export interface CapabilityVerdict {
  ...
  /** One warm plain-words reason I can speak. Set on handoff/module. */
  why?: string
}
 ...
 *  Imperium module already IS that application, I points at the real thing -
