...
/**
 * The Library descriptor. Like I, this is a special locked tile (NOT an href
 ...
 * new one. Tapping it navigates to /app/create (the full-screen "Built by I"
...
export const CREATE_TILE = {
  ...
  orb: { mode: 'wander' },
  /** Top-right 4-point spark glyph: the "Built by I" build mark. */
  glyph: (
    <svg viewBox="-12 -12 24 24" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round">
 ...
 *
 * Finance is deliberately NOT here: it is a WORKING module that fully feeds I
...
/** The I centrepiece descriptor. I is locked: never draggable or removable. */
...
export type HomeTileId = CoreTileId | 'I' | 'library' | 'create' | 'forge'
 ...
 * Vitals the daily signal, Finance the working money tile, I the 2x2 centre.
