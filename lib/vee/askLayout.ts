/*
 * I ask-card layout picker.
 *
 * I asks every clarifying question as a cozy card, but a paid app should never
 ...
 * in public/mentor-ask-layouts.html (the kit library, Page 3 of the I kit).
 *
