 ...
 * I cross-referenced to find it, so the Noticed card can show "Vitals x Train x
 ...
 * accountability in the same gamified system: feed I more, and it has more
...
const SOURCE_KEYWORDS: Array<[SeamSource, string[]]> = [
  ...
  // Finance is a core tile (works, fully feeds I), so it is a seam source.
