 ...
 * fuel, your goal, and what you told I. This engine fuses those into ONE call
...
export interface SignalChip {
  source: 'WHOOP' | 'Oura' | 'Train' | 'Fuel' | 'I'
  label: string
  qualifier: string
...
function buildChips(
  ...
  // I (an injury or constraint the user told the mentor about).
