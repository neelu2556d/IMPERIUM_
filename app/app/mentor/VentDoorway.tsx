...
// Bold the one emphasis phrase inside I's reply (if present), so any dynamic
...
// — never a hardcoded claim that "I read your data" when it didn't.
export default function VentDoorway({ teaser, onVentHere }: { teaser: VentTeaser; onVentHere: () => void }) {
  return (
    <section className={styles.contextSec} aria-label="vent with I">
      ...
      <div className={styles.door}>
        <div className={styles.doorHead}>Vent with I in Claude</div>
        ...
        <div className={styles.doorThread}>
          ...
          <div className={styles.bubVee}>{renderVee(teaser.I, teaser.emphasis)}</div>
          <div className={styles.doorTag}>
            {teaser.real
              ? 'Real. I read your actual data.'
              : 'A sample. This becomes yours once I has a few days of your data.'}
          </div>
        </div>
