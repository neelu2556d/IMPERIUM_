/**
 * I Goals — domain types for the authoritative Supabase model
...
/** Per-goal accountability: how much I shows up about this goal. */
...
export interface BigGoal {
   ...
   *  own tile streams. null/absent = let I decide (auto-binding). Optional so
